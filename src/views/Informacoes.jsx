        ...
        <Col xs={12} md={8}>
          <Card className="mt-5" >
            <Card.Body style={{ ...containerStyle, maxWidth: '100%', borderradius:'5px' }}>
              <Card.Title className="text-center mb-4" style={{color:"white",fontWeight:"bolder"}}>INFORMAÇÕES</Card.Title>
              <Card.Text>
                {user.nome && 
                  <input type="text" value={user.nome} className="form-control" disabled />
                }
              </Card.Text>
              <Card.Text>
                {typeof user.pontuacao === 'number' && 
                  <input type="text" value={`Pontuação: ${user.pontuacao}`} className="form-control" disabled />
                }
              </Card.Text>
              <Card.Text>
                {typeof user.respondido === 'number' && 
                  <input type="text" value={`Questões respondidas: ${user.respondido}`} className="form-control" disabled />
                }
              </Card.Text>
