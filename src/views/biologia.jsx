  ...
  useEffect(() => {
    async function fetchQuestions() {
      try {
        ...
        const mathQuestions = response.data.filter(question => question.subject === 'biologia').slice(0,5);
        ...
        <Card.Body style={{backgroundImage: `url(${backgroundImage})`, backgroundSize: 'cover', backgroundPosition: 'center', borderRadius:"5px"}}>
          ...
          <div style={{ textAlign: 'center', margin: "5px" }}>
            {showNextButton || showFinishButton ? (
              <Button variant="primary" style={{textAlign:"center",margin:"5px"}} onClick={showFinishButton ? handleFinishQuiz : handleNextQuestion}>
